...
**Version 10.12.2 - Maps and links reorganization patch**

Version 10.12.2 keeps the complete 10.12.1 guide library and adds the Florence laundry flyer, both Copenhagen passport wait links, prep-tab refresh persistence, and the reviewed Google Translate fallback sequence.
...
Version 10.12.1 is the current production release. Version 10.12.2 is developed and tested on `develop` before its next merge to `main`.
...
- Version 10.12.2 creates schema 6 backups and continues to import schema 5, schema 4, and older supported backups automatically.
