...
**Version 10.14.3 - Data update**

Version 10.14.3 is a data update: it reconciles reviewed phone phrase changes, adds assigned seats for four flights, adds the corrected Boston Terminal A → E transfer guide, and updates the timeline and travel details from the temporary PSA agenda. The official Joe Lynch agenda is still pending; backup schema 6 is unchanged.
...
Version 10.14.2 is the previous release. Version 10.14.3 is developed and tested on `develop` before its approved merge to `main`.
...
- Version 10.14.3 creates schema 6 backups and continues to import schema 5, schema 4, and older supported backups automatically.
