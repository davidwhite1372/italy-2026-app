    ...
    const TIMELINE = [
      ...
      { step:2, travelId:"travel-2", date:"2026-10-04", start:"08:00", end:"08:15", itemType:"Train", title:"Take SkyConnect to the Main Terminal", from:"TPA Economy Parking", to:"TPA Main Terminal", mode:"SkyConnect Train", time:"10-20 min", status:"Confirmed", instructions:"Elevator to Level 1, then SkyConnect to Main Terminal.", notes:"Keep luggage together." },
      { step:3, travelId:"travel-3", date:"2026-10-04", start:"08:40", end:"09:05", itemType:"Walk", title:"TPA Main Terminal → Delta check-in / bag drop", from:"TPA Main Terminal", to:"Delta check-in / bag drop", mode:"Walk", time:"15-25 min", status:"Confirmed", instructions:"Check bags through to FCO. Photograph baggage tags.", notes:"Verify final destination reads FCO." },
      { step:4, travelId:"travel-4", date:"2026-10-04", start:"09:05", end:"09:35", itemType:"Walk", title:"Delta check-in → TPA departure gate", from:"Delta check-in", to:"TPA departure gate", mode:"Walk", time:"20-30 min", status:"Confirmed", instructions:"Clear TSA and proceed to gate.", notes:"Boarding pass and passports accessible." },
      ...
      { step:10, travelId:"travel-10", date:"2026-10-05", start:"11:05", end:"12:15", itemType:"Walk", title:"FCO - Rome Fiumicino Airport aircraft → FCO Airport baggage claim / train station", from:"FCO - Rome Fiumicino Airport aircraft", to:"FCO Airport baggage claim / train station", mode:"Walk", time:"45-70 min", status:"Confirmed", instructions:"Collect both bags, follow train icons to railway station.", notes:"No passport control expected after Schengen entry at CPH." },
      ...
      { step:23, travelId:"travel-23", date:"2026-10-10", start:"09:39", end:"11:55", itemType:"Train", title:"Firenze S.M.N. Train Station → Venezia Santa Lucia Train Station", from:"Firenze S.M.N. Train Station", to:"Venezia Santa Lucia Train Station", mode:"Italo 8904 Club Executive", time:"2h 16m", status:"Confirmed", instructions:"Board Coach 1; David seat 13, Melody seat 16. Keep valuables at seats.", notes:"Primary plan: keep the excellent first-class seats. May cancel only if the PSA group transfer becomes the better final option." },
