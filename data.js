    ...
    const TIMELINE = [
      { step:1, date:"2026-10-04", start:"06:45", end:"07:00", itemType:"Car / Drive", title:"Drive to TPA Economy Parking", from:"Spring Hill, FL", to:"TPA Economy Parking", mode:"Drive", time:"75-105 min", status:"Confirmed", instructions:"Drive via FL-589 / Veterans Expressway. Photograph parking location.", notes:"Leave extra time for traffic and parking." },
      { step:2, date:"2026-10-04", start:"08:00", end:"08:15", itemType:"Train", title:"Take SkyConnect to the Main Terminal", from:"TPA Economy Parking", to:"TPA Main Terminal", mode:"SkyConnect Train", time:"10-20 min", status:"Confirmed", instructions:"Elevator to Level 1, then SkyConnect to Main Terminal.", notes:"Keep luggage together." },
      { step:3, date:"2026-10-04", start:"08:40", end:"09:05", itemType:"Walk", title:"TPA Main Terminal → Delta check-in / bag drop", from:"TPA Main Terminal", to:"Delta check-in / bag drop", mode:"Walk", time:"15-25 min", status:"Confirmed", instructions:"Check bags through to FCO. Photograph baggage tags.", notes:"Verify final destination reads FCO." },
      { step:4, date:"2026-10-04", start:"09:05", end:"09:35", itemType:"Walk", title:"Delta check-in → TPA departure gate", from:"Delta check-in", to:"TPA departure gate", mode:"Walk", time:"20-30 min", status:"Confirmed", instructions:"Clear TSA and proceed to gate.", notes:"Boarding pass and passports accessible." },
      { step:5, date:"2026-10-04", start:"11:39", end:"14:55", itemType:"Flight", title:"TPA Airport → BOS - Boston Logan Airport Terminal A", from:"TPA Airport", to:"BOS - Boston Logan Airport Terminal A", mode:"Flight DL2706", time:"3h 16m", status:"Confirmed", instructions:"Economy.", notes:"" },
      ...
      { step:50, date:"2026-10-15", start:"07:00", end:"08:00", itemType:"Bus", title:"Take the ATVO airport bus to VCE Departures", from:"ATVO Station, Piazzale Roma", to:"VCE - Venice Marco Polo Airport Departures", mode:"ATVO Airport Bus", time:"Approx. 20-30 min + wait", status:"Plan Confirmed / Timetable Pending", instructions:"Board the first suitable ATVO Blue Express airport bus to Venice Marco Polo Airport Departures.", notes:"Verify first-morning timetable and target airport arrival around 8:00 AM." },
      { step:49, date:"2026-10-15", start:"08:00", end:"10:15", itemType:"Information", title:"VCE - Venice Marco Polo Airport entrance → VCE - Venice Marco Polo Airport SAS departure gate", from:"VCE - Venice Marco Polo Airport entrance", to:"VCE - Venice Marco Polo Airport SAS departure gate", mode:"Airport Check-in / Security", time:"2+ hr buffer", status:"Confirmed", instructions:"Complete SAS bag drop, verify both checked bags are tagged to TPA - Tampa International Airport, clear airport security, and proceed to the departure gate.", notes:"Ask where checked bags must be reclaimed and rechecked at JFK Airport." },
      { step:35, date:"2026-10-15", start:"11:00", end:"13:05", itemType:"Flight", title:"VCE - Venice Marco Polo Airport → CPH - Copenhagen Airport", from:"VCE - Venice Marco Polo Airport", to:"CPH - Copenhagen Airport", mode:"Flight SK2692", time:"2h 5m", status:"Confirmed", instructions:"Confirm bags tagged to TPA.", notes:"Connection 1h 15m." },
      { step:43, date:"2026-10-15", start:"13:05", end:"14:20", itemType:"Information", title:"CPH - Copenhagen Airport Schengen arrival gate → CPH - Copenhagen Airport U.S. departure gate", from:"CPH - Copenhagen Airport Schengen arrival gate", to:"CPH - Copenhagen Airport U.S. departure gate", mode:"Airport Connection / Exit Passport Control", time:"75-min connection", status:"Verify Day-Of", instructions:"Follow transfer signs to the non-Schengen/U.S. departure area, complete exit passport control and document checks, and proceed directly to the SK915 gate.", notes:"Shortest connection of the return itinerary; do not stop for food." },
      { step:36, date:"2026-10-15", start:"14:20", end:"17:00", itemType:"Flight", title:"CPH - Copenhagen Airport → JFK - New York John F. Kennedy Airport Terminal 1", from:"CPH - Copenhagen Airport", to:"JFK - New York John F. Kennedy Airport Terminal 1", mode:"Flight SK915", time:"8h 40m", status:"Confirmed", instructions:"Premium Economy.", notes:"Most time-sensitive connection at CPH (exit passport control)." },
      { step:37, date:"2026-10-15", start:"17:00", end:"19:00", itemType:"Walk", title:"JFK Airport Terminal 1 → JFK Airport Terminal 4 / Delta gate", from:"JFK Airport Terminal 1", to:"JFK Airport Terminal 4 / Delta gate", mode:"Walk", time:"90-120 min", status:"Confirmed", instructions:"Immigration, reclaim bags, customs, recheck, AirTrain to T4, TSA, gate.", notes:"Do not stop until through T4 security." },
      { step:38, date:"2026-10-15", start:"19:50", end:"23:13", itemType:"Flight", title:"JFK Airport Terminal 4 → TPA - Tampa International Airport", from:"JFK Airport Terminal 4", to:"TPA - Tampa International Airport", mode:"Flight SK3438 (Delta)", time:"3h 11m", status:"Confirmed", instructions:"Check Delta app for gate.", notes:"" },
      { step:39, date:"2026-10-15", start:"23:13", end:"23:55", itemType:"Train", title:"Take SkyConnect from TPA baggage claim to Economy Parking", from:"TPA Airport baggage claim", to:"TPA Airport Economy Parking", mode:"SkyConnect Train", time:"30-45 min", status:"Confirmed", instructions:"Collect bags, follow signs to SkyConnect, ride to Economy Parking, and use the parking-location photo.", notes:"Inspect vehicle before leaving." },
      { step:40, date:"2026-10-16", start:"00:00", end:"01:15", itemType:"Car / Drive", title:"Drive home to Spring Hill", from:"TPA Airport Economy Parking", to:"Spring Hill, FL", mode:"Drive", time:"60-75 min", status:"Confirmed", instructions:"Drive via Veterans / Suncoast. Stop if fatigued.", notes:"Expected home after midnight." },
    ];
