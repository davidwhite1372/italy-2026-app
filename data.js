    ...
    const TIMELINE = [
      { step:1, travelId:"travel-1", date:"2026-10-04", start:"06:45", end:"07:00", itemType:"Car / Drive", title:"Drive to TPA Economy Parking", from:"Spring Hill, FL", to:"TPA Economy Parking", mode:"Drive", time:"75-105 min", status:"Confirmed", instructions:"Drive via FL-589 / Veterans Expressway. Photograph parking location.", notes:"Leave extra time for traffic and parking." },
      { step:2, travelId:"travel-2", date:"2026-10-04", start:"08:00", end:"08:15", itemType:"Train", title:"Take SkyConnect to the Main Terminal", from:"TPA Economy Parking", to:"TPA Main Terminal", mode:"Train", time:"10-20 min", status:"Confirmed", instructions:"Elevator to Level 1, then SkyConnect to Main Terminal.", notes:"Keep luggage together." },
      { step:3, travelId:"travel-3", date:"2026-10-04", start:"08:40", end:"09:05", itemType:"Information", title:"TPA Main Terminal → Delta check-in / bag drop", from:"TPA Main Terminal", to:"Delta check-in / bag drop", mode:"Walk", time:"15-25 min", status:"Confirmed", instructions:"Check bags through to FCO. Photograph baggage tags.", notes:"Verify final destination reads FCO." },
      { step:4, travelId:"travel-4", date:"2026-10-04", start:"09:05", end:"09:35", itemType:"Information", title:"Delta check-in → TPA departure gate", from:"Delta check-in", to:"TPA departure gate", mode:"Walk", time:"20-30 min", status:"Confirmed", instructions:"Clear TSA and proceed to gate.", notes:"Boarding pass and passports accessible." },
      ...
      { step:10, travelId:"travel-10", date:"2026-10-05", start:"11:05", end:"12:15", itemType:"Information", title:"FCO - Rome Fiumicino Airport aircraft → FCO Airport baggage claim / train station", from:"FCO - Rome Fiumicino Airport aircraft", to:"FCO Airport baggage claim / train station", mode:"Walk", time:"45-70 min", status:"Confirmed", instructions:"Collect both bags, follow train icons to railway station.", notes:"No passport control expected after Schengen entry at CPH." },
      { step:11, travelId:"travel-11", date:"2026-10-05", start:"12:15", end:"13:00", itemType:"Train", title:"Fiumicino Aeroporto Train Station → Roma Termini Train Station", from:"Fiumicino Aeroporto Train Station", to:"Roma Termini Train Station", mode:"Leonardo Express", time:"32 min + wait", status:"Confirmed", instructions:"Buy tickets from official Trenitalia. Nonstop to Termini.", notes:"Do not take FL1." },
      { step:12, travelId:"travel-12", date:"2026-10-05", start:"13:00", end:"13:20", itemType:"Walk", title:"Roma Termini Train Station → Anantara Palazzo Naiadi Hotel", from:"Roma Termini Train Station", to:"Anantara Palazzo Naiadi Hotel", mode:"Walk", time:"10-15 min", status:"Confirmed", instructions:"Exit toward Piazza dei Cinquecento / Via Luigi Einaudi to Piazza della Repubblica.", notes:"Hotel: Piazza della Repubblica 48-49." },
